(function(){
    ...
    assessmentButton.onclick = () =>{
       ...
       if(userName.length === 0){   //名前が空の時は処理を終了させる
            return;
        }
       //console.log(userName);

       // 診断結果表示エリアの作成
       removeAllChildren(resultDivided);    //指定した要素の子供をすべて削除する
    ...
    const answers = [
        ...
        '{userName}のいいところは優しさです。あなたの優しい雰囲気や立ち振舞いに多くの人が癒されています。'
    ];
